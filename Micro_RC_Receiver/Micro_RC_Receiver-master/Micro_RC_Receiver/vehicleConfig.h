...
#define MSE_Mouse // CONFIG_GENERIC_V14 // <- Select the correct vehicle configuration here before uploading!
...
// Generic configuration, board v1.4 -----------------------------------------------------------------------------
#ifdef CONFIG_GENERIC_V14
// Battery type
boolean liPo = true;
float cutoffVoltage = 3.6;
...
boolean HP = false; // High Power Board!
...
byte lim2L = 45, lim2R = 135;
byte lim3L = 45, lim3R = 135;
byte lim3Llow = 45, lim3Rlow = 135; // limited top speed angles!
byte lim4L = 45, lim4R = 135;
...
// Motor configuration
int maxPWMfull = 255;
int maxPWMlimited = 255;
int minPWM = 0;
byte maxAccelerationFull = 7;
byte maxAccelerationLimited = 7;
